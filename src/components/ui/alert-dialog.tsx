...
const AlertDialogContent = React.forwardRef<View, React.ComponentPropsWithoutRef<typeof View>>(
      ...
      >
        ...
        >
          ...
          <Pressable>
            <View
              ref={ref}
              className={cn('w-full max-w-sm rounded-lg border bg-card p-6 shadow-lg', className)}
              {...props}
            >
              {children}
            </View>
...
const AlertDialogTitle = ({ className, ...props }: React.ComponentPropsWithoutRef<typeof Text>) => (
...
const AlertDialogAction = ({ ...props }: React.ComponentPropsWithoutRef<typeof Button>) => (
  <Button {...props} />
);
AlertDialogAction.displayName = 'AlertDialogAction';

const AlertDialogCancel = ({ ...props }: React.ComponentPropsWithoutRef<typeof Button>) => {
  const { setOpen } = useAlertDialog();
